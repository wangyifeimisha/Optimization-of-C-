				...
				ZipCode &UnitTest_Zip)
{
	...
	// ----------------------------------------------------
		...
		// ADD CODE HERE:
		std::set< ZipCode > zippy{ std::begin(data), std::end(data) };  // <-- REPLACE this LINE... shuts up warnings, its 100% wrong
	...
	// ----------------------------------------------------
		...
		// ADD CODE HERE:
		zippy_it = zippy.find({ "Bee", 0xFFEE });
	...
	// ----------------------------------------------------
		...
		// ADD CODE HERE:
		zippy_it = std::find_if(zippy.begin(), zippy.end(), IsBB77);
